...
namespace FoxKit.Modules.DataSet.Fox.Sim
{
    ...
    public partial class SimDaemon : Entity
    {
        ...
        [ExposeMethodToLua(MethodStaticity.Static)]
        static partial void SetForceSimLocalMode(lua_State lua);
        
        [ExposeMethodToLua(MethodStaticity.Static)]
        static partial void SetForceSimNotActiveMode(lua_State lua);
        
        [ExposeMethodToLua(MethodStaticity.Static)]
        static partial void SetForceStopSimWindEffect(lua_State lua);
        
        [ExposeMethodToLua(MethodStaticity.Static)]
        static partial void SetSimWorkSize(lua_State lua);
    }
}
