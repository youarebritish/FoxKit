...
namespace KopiLua
{
    ...
    public static class LuaManager
    {
        ...
        public static int dostring(Lua.lua_State L, Lua.CharPtr s, Lua.CharPtr name)
        {
                    ...
                    case 'e':
                        {
                            ...
                            if (chunk == string.Empty) chunk = argv[++i];
                    ...
                    case 'l':
                        {
                            ...
                            if (filename == string.Empty) filename = argv[++i];
        ...
        static int pmain(Lua.lua_State L)
        {
            ...
            globalL = L;
            if ((argv.Length > 0) && (argv[0] != string.Empty)) progname = argv[0];
